...
CMEMS_SLA_process = function(path, list_filename, varid, newvarid, domain, temp, outputDir, meridian, start, end, tempdir=NULL) {
  ...
  for (filename in list_filename){
    ...
    GLORYS = paste0("CMEMS_SLA_", ifelse(varid_name == "thetao", "sst", varid), "_temp")
  ...
  output_file = paste0("cmems-obs",domain,"-",newvarid,"-",temp,"-",start,"-",end,".nc")
